...
<html class="no-js"  lang="en">
	...
	@endif
								...
								<div class="tab-content">
											...
											<p>seleccione la fecha a publicar: <input type="date" id="dateDay" name="date" value="{{$day->day_week}}" onchange="dayweek()"></p>
							...
							<div class="single-package-item">
								...
								<div class="single-package-item-txt">
									...
									<div class="packages-para">
										<ul id="lstsoup" >
										@foreach($day_soups as $soupD)
										<li id="lissp{{$soupD->id}}"> <input name="idsoups[]"  readonly="readonly" style="border:0px; width:0;" value="{{$soupD->id}}"><span><i class="fa fa-angle-right"></i><input name="ltsoups[]" readonly="readonly" style="border:0px;" value="{{$soupD->name}}"><a  onclick="delSoup({{$soupD->id}})"><em class="fa fa-trash"></em></a></span></li>
						...
						<div class="col-md-3 col-sm-6">
							<div class="single-package-item">
								...
								<div class="single-package-item-txt">
									...
									<div class="packages-para">
										<ul id="lstprinciple" >
										@foreach($day_principles as $princD)
											<li id="lispe{{$princD->id}}"><input name="idprinciples[]" type="hidden" readonly="readonly" style="border:0px" value="{{$princD->id}}"><span><i class="fa fa-angle-right"></i><input name="ltprinciples[]" readonly="readonly" style="border:0px" value="{{$princD->name}}"><a  onclick="delPrinciple({{$princD->id}})"><em class="fa fa-trash"></em></a></span></li>
										@endforeach
						...
						<div class="col-md-3 col-sm-6">
							<div class="single-package-item">
								...
								<div class="single-package-item-txt">
									...
									<div class="packages-para">
										<ul id="lstmeat" >
										@foreach($day_meats as $meatD)
										<li id="lismt{{$meatD->id}}"> <input name="idmeats[]" type="hidden" readonly="readonly" style="border:0px" value="{{$meatD->id}}"> <span><i class="fa fa-angle-right"></i><input name="ltmeats[]" readonly="readonly" style="border:0px" value="{{$meatD->name}}"><a onclick="delMeat({{$meatD->id}})"><em class="fa fa-trash"></em></a></span></li>
										@endforeach
						...
						<div class="col-md-3 col-sm-6">
							<div class="single-package-item">
								...
								<div class="single-package-item-txt">
									...
									<div class="packages-para">
										<ul id="lstbeverage" >
										@foreach($day_beverages as $bevD)
										<li id="lisbg{{$bevD->id}}"><input name="idbeverages[]" type="hidden" readonly="readonly" style="border:0px" value="{{$bevD->id}}"> <span><i class="fa fa-angle-right"></i><input name="ltbeverages[]" readonly="readonly" style="border:0px" value="{{$bevD->name}}""><a  onclick="delBeverage({{$bevD->id}})"><em class="fa fa-trash"></em></a></span></li>
										@endforeach
